...
<ul>
    ...
    <li>בנוסף, בעת ביצוע login התא משייך לסשיין הנוכחי של היוזר JWT token ושומר אותו בקוקיז, ובעת כניסה לכל דף מודוא שאכן זה היוזר שנכנס מקודם. על מנת לשמור על בטחון המידע של החייל</li>
